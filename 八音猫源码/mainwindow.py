    ...
    def processText(self):
        ...
        if self.file_drop.yaml_path:
            if self.host_zone.hostinfo.toPlainText():
                ...
                dns_list = self.checkDNS()
                finished = mj.SaveJsonFile(self.file_drop.yaml_path,save_path,dns_list,10800,hyjack=False)
            if finished:
